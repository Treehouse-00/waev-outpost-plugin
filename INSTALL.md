...
An existing [openHop Repeater](https://github.com/openhop-dev/openhop_repeater) installation. waev:outpost is served by openHop Repeater's CherryPy server; installing it on its own does nothing useful.
